<%@ Page Language="C#" MasterPageFile="~/Manager/MasterPage/Admin_1.master" AutoEventWireup="true" CodeFile="CFDetail.aspx.cs" Inherits="Manager_CFDetail" %>
                ...
                <table id="Table6" border="1" cellspacing="0" class="Forumrow" rules="all" style="width: 100%;
                    ...
                    <tr>
                        <td align="right" class="ColumnTD" style="width: 15%">
                            檔案：</td>
                        <td align="left">
                            <asp:HyperLink ID="linkFile" runat="server" Target="_blank">下載</asp:HyperLink></td>
                    </tr>
