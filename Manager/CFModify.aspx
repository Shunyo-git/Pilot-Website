<%@ Page Language="C#"  ValidateRequest="false" MasterPageFile="~/Manager/MasterPage/Admin_1.master" AutoEventWireup="true"
    CodeFile="CFModify.aspx.cs" Inherits="Manager_CFModify" %>
                     ...
                     <tr>
                        ...
                        <td align="left">
                            ...
                            上傳圖片：<uc1:UploadControl  ID="UploadControl1" runat="server" FileTypeRange="jpg,gif"
                                ...
                                Icon_Validate_Tick="image/icon_validate_Tick.gif"   MaxWidth="121" MinHeight="90"
                                 FileControlWidth="60%" />
                           <br />
                                ◎圖檔格式JPG或GIF。 <br /><br />
                       ...
                       <tr>
                        ...
                        <td align="left">
                                ...
                                <asp:HyperLink ID="linkFile" runat="server" Target="_blank">下載</asp:HyperLink> <br />
                            上傳圖片：<uc1:UploadControl  ID="UploadControl2" runat="server" FileTypeRange="mp4"
                                Icon_Validate_Cross="image/icon_validate_cross.gif" Icon_Validate_Spacer="image/icon_validate_Spacer.gif"
