<%@ Page Language="C#" MasterPageFile="~/Manager/MasterPage/Admin_1.master" AutoEventWireup="true" CodeFile="CFList.aspx.cs" Inherits="Admin_CFList" %>
...
<table id="table1" align="center" border="0" cellpadding="3" cellspacing="1" class="tableBorder"
        ...
        <tr>
            <td align="right" class="Forumrow" style="height: 28px">
                ...
                <asp:LinkButton ID="lbtnNew" runat="server" OnClick="lbtnNew_Click">新增廣告</asp:LinkButton></td>
                     </tr>
                     <tr>
                         <td>
                         </td>
                        ...
                        <Columns>
                            <asp:BoundField DataField="ID" HeaderText="自動編號" SortExpression="ID">
                             ...
                             <asp:TemplateField HeaderText="封面"  >
                                ...
                                <HeaderStyle CssClass="grid-header" ForeColor="#336600" />
                                <ItemTemplate>
                                  <img src="/Upload/CF/<%#Eval("ID")%>.jpg" width="50">
                                </ItemTemplate>
                            </asp:TemplateField>
