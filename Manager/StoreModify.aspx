    ...
    <table border="0" cellpadding="0" cellspacing="0" style="width: 759px">
        <tr>
            ...
            <td align="right" style="height: 22px">
                <img src="image/icon-save.gif" width="14" height="18" />&nbsp;
                <asp:LinkButton ID="lbtnSave" runat="server" OnClick="lbtnSave_Click">儲存</asp:LinkButton>&nbsp;
                <img src="image/icon-cancel.gif" width="18" height="18" />
                    ...
                    <tr>
                        ...
                        <td align="left">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtTel"
                                ErrorMessage="電話不能空白" ToolTip="電話不能空白"><img src="image/icon_validate_cross.gif" align="absmiddle" width="12" height="12" /></asp:RequiredFieldValidator></td>
                    </tr>
                    <tr>
                        <td align="right" class="ColumnTD" width="15%">
                         地址：</td>
                        <td align="left">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtAddress"
                                ErrorMessage="地址不能空白" ToolTip="地址不能空白"><img src="image/icon_validate_cross.gif" align="absmiddle" width="12" height="12" /></asp:RequiredFieldValidator></td>
                    </tr>
                    <tr>
                        <td align="right" class="ColumnTD" width="15%">
                        網址：</td>
